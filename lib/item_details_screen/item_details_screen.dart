                    ...
                    children: [
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage(controller.model.banners[index]),
                                  ),
                                ),
                              ),
                            );
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            for (int i = 0; i < controller.model.banners.length; i++) indicator(size, false)
                          ],
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            style: const TextStyle(fontSize: 19, color: Colors.black, fontWeight: FontWeight.w500, decoration: TextDecoration.lineThrough),
                            children: [
                              TextSpan(
                  ...
                  children: [
                    Expanded(
                      child: customButtom(
                        ...
                        Colors.redAccent,
                        controller.isAlreadyAvailable ? "Go to Cart" : "Add to Cart",
                      ),
                    ),
                    Expanded(
