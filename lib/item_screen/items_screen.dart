...
import 'package:ecommerce/item_screen/item_screen_controller.dart';
import 'package:ecommerce/item_screen/items_model.dart';
import 'package:ecommerce/item_screen/searcg.dart';
...
class ItemsScreen extends StatelessWidget {
  ...
  ItemsScreen({Key? key, required this.categoryTitle, required this.categoryId}) : super(key: key);
  ...
  Widget listViewBuilderItems(Size size, ItemsModel model) {
    int discount = controller.calculateDiscount(model.totalPrice, model.sellingPrice);
